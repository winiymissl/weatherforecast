...
public class TableOperation {
    public static void inTable(Context context, String b, String c) {
        QWeather.getGeoCityLookup(context, c, b, Range.CN, 1, Lang.ZH_HANS, new QWeather.OnResultGeoListener() {
            @Override
            public void onError(Throwable throwable) {
                Log.d("getGeoCity", throwable.toString());
            }
            ...
            public void onSuccess(GeoBean geoBean) {
                ...
                if (geoBean.getCode() == Code.OK) {
                    ...
                    MyDBH myDBH1 = MyDBH.getMyDBH(context);
                    ...
                    QWeather.getWeather3D(context, id, new QWeather.OnResultWeatherDailyListener() {
                        @Override
                        public void onError(Throwable throwable) {
                    ...
                    QWeather.getWeather24Hourly(context, id, new QWeather.OnResultWeatherHourlyListener() {
                        @Override
                        public void onError(Throwable throwable) {
                    ...
                    QWeather.getAirNow(context, id, Lang.ZH_HANS, new QWeather.OnResultAirNowListener() {
                        @Override
                        public void onError(Throwable throwable) {
                    ...
                    QWeather.getIndices1D(context, id, Lang.ZH_HANS, indices, new QWeather.OnResultIndicesListener() {
                        @Override
                        public void onError(Throwable throwable) {
